document.addEventListener('DOMContentLoaded', () => {
    ...
    const jinNodes = [
		...
		{ id: 'CS1', label: 'Chū Shōu - 1', path: 'Chu_Shou/Part1' },
		{ id: 'CS2', label: 'Chū Shōu - 2', path: 'Chu_Shou/Part2' },
		{ id: 'QAB', label: 'Qiánzú Tāng Ǎo Bù', path: 'Qiang_Tang_Ao_Bu' },
    ...
    const jinLinks = [
		...
		{ source: 'XX2', target: 'CS1', id: 'e10' },
		{ source: 'CS1', target: 'CS2', id: 'e11' },
		{ source: 'CS1', target: 'TYZ', id: 'e12' },
		{ source: 'CS2', target: 'QAB', id: 'e13' },
		{ source: 'XX1', target: 'JDC', id: 'e14' },
        { source: 'DB', target: 'JG_J2', id: 'e15' },
        { source: 'JG_J2', target: 'BZK', id: 'e16' },
        { source: 'BZK', target: 'BSC', id: 'e17' },
        { source: 'BSC', target: 'QLC', id: 'e18' },
        { source: 'QLC', target: 'ST', id: 'e19' },
        { source: 'ST', target: 'SHZ', id: 'e20' },
        { source: 'SHZ', target: 'ZDC', id: 'e21' },
        { source: 'ZDC', target: 'DJH', id: 'e22' },
        { source: 'DJH', target: 'TYZ', id: 'e23' },
        { source: 'TYZ', target: 'ZP', id: 'e24' },
        { source: 'YS', target: 'GTM', id: 'e25' },
        { source: 'GTM', target: 'CZ', id: 'e26' },
        { source: 'YS', target: 'SBL', id: 'e27' },
        { source: 'JDC', target: 'FEQJ', id: 'e28' },
        { source: 'FEQJ', target: 'HXC', id: 'e29' },
    ];
    ...
    const appNodes = [
		...
		{ id: 'LZY', label: 'Lǎn Zhā Yī', path: 'Lan_Zha_Yi' },
		{ id: 'LFSB', label: 'Liù Fēng Sì Bì', path: 'Liu_Feng_Si_Bi' },
		{ id: 'XX1', label: 'Xie Xing - 1', path: 'Gao_Tanma' },
		{ id: 'CS1', label: 'Chū Shōu - 1', path: 'Chu_Shou/Part1' },
		{ id: 'CS2', label: 'Chū Shōu - 2', path: 'Chu_Shou/Part2' },
		{ id: 'ZDC', label: 'Zhǒu Dǐ Chuí', path: 'Zhou_Di_Chui' },
    ...
    const appLinks = [
		{ source: 'DingBu', target: 'XX1', id: 'a0' },
		{ source: 'DingBu', target: 'CS1', id: 'a1' },
		{ source: 'CS1', target: 'ZDC', id: 'a2' },
		{ source: 'ZDC', target: 'LFSB', id: 'a3' },
		{ source: 'CS1', target: 'CS2', id: 'a4' },
		{ source: 'Mirror Wrist Grab', target: 'LZY', id: 'a5' },
		{ source: 'Mirror Wrist Grab', target: 'GTM', id: 'a6' },
		{ source: 'Inner-Elbows Grab', target: 'LFSB', id: 'a7' },
		{ source: 'Inner-Elbows Grab', target: 'YS', id: 'a8' },
    ];
